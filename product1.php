...
<div class="right">
  ...
  <div class="gallery">
    <a target="_blank"  name="image-swap3" href="img/hoodie1fYellow.jpg">
      <img name="image-swap1" src="img/hoodie1fYellow.jpg" alt="Hoodie front" width="600px" height="`400px">
    </a>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank"  name="image-swap4" href="img/hoodie1bYellow.jpg">
      <img  name="image-swap2" src="img/hoodie1bYellow.jpg" alt="Hoodie back" width="600" height="400">
    </a>
    
  </div>
</div>
 <div style=" background-color:lightblue;padding:10px;text-align:center;">
   <p> Details<br>ADRO Men's Alan Walker Printed Cotton Hoodies<br> MRP: 500 ₹</p>
  ...
  <select id="Quantity" name="Quantity">
    ...
    <option value=4>4</option>
  	...
  	<input type="hidden" value="101" name="ProductID"  >
...
function setImage(select){
  ...
  image1.src = "img/hoodie1f"+select.options[select.selectedIndex].value+".jpg";
   var image2 = document.getElementsByName("image-swap2")[0];
  image2.src = "img/hoodie1b"+select.options[select.selectedIndex].value+".jpg";
    var image3 = document.getElementsByName("image-swap3")[0];
  image3.href = "img/hoodie1f"+select.options[select.selectedIndex].value+".jpg";
   var image4 = document.getElementsByName("image-swap4")[0];
  image4.href = "img/hoodie1b"+select.options[select.selectedIndex].value+".jpg";
}
</script>
